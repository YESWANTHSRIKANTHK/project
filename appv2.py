...
def main():
    ...
    if uploaded_file is not None:
        with open(r"C:\Users\YESWANTH\Downloads\0x0.jpg", 'wb') as f:
            f.write(uploaded_file.getvalue())
           
    if st.button('Detect'): 
        image = cv2.imread(r"C:\Users\YESWANTH\Downloads\0x0.jpg")
        ...
        img = Image.open(r"C:\Users\YESWANTH\Downloads\0x0.jpg")
        st.image(img)
        st.warning(final)
        #say_text(final)
        if engine._inLoop:
